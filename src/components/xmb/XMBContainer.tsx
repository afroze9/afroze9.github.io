    ...
    return [
      {
        ...
        icon: 'user',
        items: [
          { id: 'about', label: profile.name, subtitle: profile.title, icon: 'user', data: profile },
          { id: 'philosophy', label: 'Philosophy', subtitle: 'Guiding principles', icon: 'heart', data: profile.philosophy },
          { id: 'education', label: 'Education', subtitle: profile.education[0]?.institution, icon: 'graduation-cap', data: profile.education },
          { id: 'contact', label: 'Contact', subtitle: 'Get in touch', icon: 'mail', data: profile.contact },
          ...skills.map((skill) => ({
            id: skill.id,
            label: skill.name,
